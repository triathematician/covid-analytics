    ...
    fun invoke(series: TimeSeries): ExtremaSummary {
        ...
        return ExtremaSummary(series).apply {
            combined.mapIndexed { i, pair ->
                ...
                ExtremeInfo(series.metric, series.date(pair.first), current, pair.second, previous?.percentChangeTo(current))
...
/** Types of extrema. */
enum class ExtremeType { LOCAL_MAX, LOCAL_MIN, ENDPOINT }
