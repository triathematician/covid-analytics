...
//    constructor(areaId: String, vararg metrics: TimeSeries): this(areaId) {
...
//        get() = metrics.map { it.toMetricTimeSeries(areaId) }
//
//    operator fun plusAssign(m: TimeSeries) {
...
//        }
//
//    fun toMetricTimeSeries(areaId: String) = TimeSeries(areaId, id, "", intSeries, defValue.toDouble(), start, values.map { it.toDouble() })
//
//}