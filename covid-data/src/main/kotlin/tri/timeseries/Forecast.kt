...
data class Forecast(val model: String, val forecastDate: LocalDate, val region: RegionInfo, val metric: String, val data: List<MetricTimeSeries>) {
...
data class ForecastId(val model: String, val forecastDate: LocalDate, val region: RegionInfo, val metric: String)